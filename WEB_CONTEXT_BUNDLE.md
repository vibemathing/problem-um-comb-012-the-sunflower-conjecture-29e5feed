...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-comb-012-the-sunflower-conjecture-29e5feed-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/COMB-012"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-comb-012-the-sunflower-conjecture-29e5feed-v1",
      "problem_contract_sha256": "d9b4e8140ad7fbff7f5658c6187548a178e6e10867eccc2b4fb845e745012ed5",
      "problem_id": "problem:um-comb-012-the-sunflower-conjecture-29e5feed",
      "route_id": "route:um-comb-012-the-sunflower-conjecture-29e5feed-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-comb-012-the-sunflower-conjecture-29e5feed-source-fidelity-01",
      "graph_id": "graph:um-comb-012-the-sunflower-conjecture-29e5feed-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-comb-012-the-sunflower-conjecture-29e5feed-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-comb-012-the-sunflower-conjecture-29e5feed-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Does every family of at least $c^k k!$ sets of size $k$ contain a sunflower of size 3, for some absolute constant $c$?"
          },
          "statement_sha256": "c99d34c13a6f8627a38dedbe4dfcb5c9c5eeeebf47bc0d119535445873af8d4b"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-comb-012-the-sunflower-conjecture-29e5feed-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-comb-012-the-sunflower-conjecture-29e5feed-root",
      "route_id": "route:um-comb-012-the-sunflower-conjecture-29e5feed-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-comb-012-8c3493c40bf5",
        "url": "https://www.unsolvedmath.com/problems/COMB-012"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
